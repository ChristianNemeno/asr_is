# Agent Skills - OpenCode Documentation
...
OpenCode lists available skills in the skill tool description. Each entry includes the skill name and description. The agent loads a skill by calling the tool: `skill({ name: "git-release" })`.
